...
// 				className='p-3 rounded-full bg-surface-light dark:bg-surface-dark shadow-lg hover:shadow-xl transition-all duration-300'
// 			>
// 				<Palette className='w-6 h-6 text-primary-light' />
// 			</button>
...
// 						exit={{ opacity: 0, y: 20 }}
// 						className='absolute bottom-16 right-0 bg-white dark:bg-surface-dark rounded-lg shadow-xl p-4 w-64'
// 					>
